...
export default function App() {
  const [list, setList] = useState([
    {
      type: 'video',
      url: 'https://www.youtube.com/embed/drZ2We-JVYk?rel=0&amp;controls=0&amp;showinfo=0',
      views: 77
    },
    {
      type: 'video',
      url: 'https://www.youtube.com/embed/RAh10A_oM0c?rel=0&amp;controls=0&amp;showinfo=0',
      views: 1290
    },
    {
      type: 'article',
    ...
    {
      type: 'video',
      url: 'https://www.youtube.com/embed/daPhcJJ8T5E?rel=0&amp;controls=0&amp;showinfo=0',
      views: 4253
    },
    {
      type: 'article',
